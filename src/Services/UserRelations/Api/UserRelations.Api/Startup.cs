...
using Kwetter.Services.UserRelations.Api.Services;
using Kwetter.Services.UserRelations.Application;
using Kwetter.Services.UserRelations.Infrastucture;
...
namespace Kwetter.Services.UserRelations.Api
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IEventBus eventBus,
            IdentityConfig identityConfig, ILogger<Startup> logger)
        {
            ...
            {
                endpoints.MapGrpcService<FollowingService>();
